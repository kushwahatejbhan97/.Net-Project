<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ciril.aspx.cs" Inherits="Sidvin.ciril" %>
 ...
 <head>
  ...
  <body>
    ...
    <section class="w3l-about-breadcrumb servicesimg">
      <div class="breadcrumb-bg breadcrumb-bg-ciril py-5">
        <div class="container py-lg-5 py-md-3">
          <h2 class="title">Ciril</h2>
        </div>
      </div>
    </section>
    ...
    <!-- Service Section -->
    <!-- bottom-grids-->
    <section class="w3l-bottom-grids-6 py-5" id="service">
                ...
                <div class="boxed boxedp4">
                    ...
                    <li><a href="#">Land Services.</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="small-box">
                                <h4>Offices</h4><br />
                                <small>23, Clients: 160+ , Mn Sft Tranactions : 5.50 + , Year of Commercial Real Estate Experience : 25+ , Team Size : 450+ </small>
                            </div><!-- end small-box --><br />
                            
                            Website: <a href="https://WWW.ciril.in/">WWW.ciril.in </a>
                            <br />
                           Email : <a href="mailto:info@ciril.in?Subject=Feedback&amp;Body=start"
                        >info@ciril.in</a>
                        </div><!-- end col -->

                        <div class="col-md-4">
                            <div class="small-box">
                                <h4>Our Presence</h4><br />
                                <small>Ahmedabad. Bangalore. Bhubaneshwar. Chennai. Coimbatore. Delhi . Gurgaon. Guwahati . Hyderabad. Indore. Jaipur. Kolkata. Kochi. Mumbai. Noida. Nagpur. Navi Mumbai. Nashik. Pune. Ranchi . Rajkot. Surat. Siliguri. Vadodara . </small>
