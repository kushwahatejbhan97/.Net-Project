<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubCatDetails.aspx.cs" Inherits="KiranaWorldApp.SubCatDetails" %>
 ...
 <div class=" container" id="headertop" runat="server"  style="background:#84c225; position: fixed;  height:50px; width:100%; color:#fff; z-index:40;  " >
  <div class="mm-toggle-wrap"  style="   position: fixed; width:20%; z-index:40;  " >
        ...
        <div style="   position: fixed; width:58%; left:20%; top:16px; font-size:16px; z-index:40; text-align:center;">
           <div ><asp:Label ID="catname" style=" font-weight:600; color:White; font-size:16px; " runat="server" Text=""></asp:Label>
  ...
  <div class="titleback" style=" background-image:url('strip/4.jpg'); color:White; " >
  ...
  <div class="divCategory container"  id="div2" runat="server" visible="true">

  <div class="row" style="max-width:480px; margin:0 auto;">
   <asp:Repeater ID="RepeaterSubCategory" runat="server"  DataSourceID="SqlDataSource3">
                        <ItemTemplate>
  <div class="Category col-xs-4 col-sm-4 col-md-2 col-lg-2">
  
   <a  href='ItemList.aspx?Type=5&SubCatId=<%# Eval("SubCatId") %>'> <img src='https://www.kiranaworld.in/Admin/Subcategory/Mobile/<%# Eval("SubMobImg") %>' class="img-responsive" /> </a>                   
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
  <div class="titleback" style=" background-image:url('strip/8.jpg'); color:#121f67; display: inline-block; font-size:15px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden " >
  
      
       Featured Products From <%=catname.Text%>
  
  </div>
  <div class="divHotproducts container" style=" padding-left:1px; padding-right:1px;" >
     ...
     <div id="snackbar" runat="server" style=" z-index:22" >
        ...
        <div class="panel-heading active" style=" background-color: #22263e; font-size: 15px; padding:15px;  text-align: center; color: White; z-index: 500;  ">
         <asp:Label ID="ItemName" style="font-size:18px; overflow: hidden; display:inline-block; width:200px; text-overflow: ellipsis; white-space: nowrap;" runat="server" Text=""></asp:Label>
                    ...
                    <a href="javascript:void(0)"   id="closechoose" onclick="hideme()" class="closechoose " style="font-size:20px; float:right; padding-right: 8px; "><img src="img/closeiconfafa.png" id="closemeimg" runat="server" /></a> 
