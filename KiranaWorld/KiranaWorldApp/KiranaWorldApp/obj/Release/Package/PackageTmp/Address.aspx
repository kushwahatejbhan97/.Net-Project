<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Address.aspx.cs" Inherits="KiranaWorldApp.Address" %>
...
<div id="page" > 
  ...
  <div class="mm-toggle-wrap"  style="   position: fixed; width:20%; " >
		...
		<div style="   position: fixed; width:58%; left:20%; top:17px; "  >
		   <h4 style="text-align:center; color:#fff">Add Address</h4>
  ...
  <label>*Flat No / House no</label>
	  <asp:TextBox ID="Addressline1" CssClass="form-control" runat="server"></asp:TextBox>
	   <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="Enter Your Address!" ControlToValidate="Addressline1" Display="Dynamic"  ForeColor="red" ValidationGroup="BuyLotNewdadd"></asp:RequiredFieldValidator>
  </div>
  ...
  <label>*Street details to locate you</label>
	 <asp:TextBox ID="Addressline2"  CssClass="form-control" runat="server" type="text" placeholder="Street Name" ValidationGroup="BuyLotNewdadd"></asp:TextBox>
	  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Your Address!" ControlToValidate="Addressline2" Display="Dynamic"  ForeColor="red" ValidationGroup="BuyLotNewdadd"></asp:RequiredFieldValidator>
	 </div>
  </div>
  <div class="row" style="margin-top:10px">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <label>*Pincode</label>
	<asp:DropDownList ID="tb_pin" AutoPostBack="true" AppendDataBoundItems="True" 
   ...
   <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
	<label>*Area</label>
	   <asp:DropDownList ID="Area" CssClass="form-control" 
	   ...
	   <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
														...
														<SelectParameters>
															<asp:ControlParameter ControlID="tb_pin" DefaultValue="0" Name="pin" 
																PropertyName="SelectedValue" Type="Int32" />
														</SelectParameters>
													</asp:SqlDataSource>
	   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="Select" runat="server" ErrorMessage="Select Your Area!" ControlToValidate="Area" Display="Dynamic"  ForeColor="red" ValidationGroup="BuyLotNewdadd"></asp:RequiredFieldValidator>
  </div>
  </div>
 ...
 <asp:Button ID="Button1" style="width:100%" CssClass="Address" runat="server" 
		Text="Add Address" onclick="Button1_Click"></asp:Button>
