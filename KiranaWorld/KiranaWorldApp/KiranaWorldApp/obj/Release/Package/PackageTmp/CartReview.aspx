<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CartReview.aspx.cs" Inherits="KiranaWorldApp.CartReview" %>
...
<div id="page" > 
 ...
 <div class=" container" id="headertop" runat="server"  style="background:#84c225; position: fixed;  height:50px; width:100%; color:#fff; z-index:40;  " >
  <div class="mm-toggle-wrap"  style="   position: fixed; width:20%; z-index:40;  " >
			...
			<a href="Home.aspx"><img src="img/backbtn.png" alt="back" /></a>
			</div>
			  </div>
		<div style="   position: fixed; width:58%; left:20%; top:16px; font-size:16px; z-index:40; text-align:center;">
		   <div ><asp:Label ID="catname" style=" font-weight:600; color:White; font-size:16px; " runat="server" Text="Your Basket"></asp:Label>
...
<div class="titleback" style=" background-image:url('strip/15.jpg'); color:White; height:40px; font-size:15px; padding-top:11px; " >
 ...
 <div class=" container row" style="border-bottom:2px solid #84c225; padding-top:4px;" >
	<a href="Coupon.aspx">  <img src="img/couponifo.png" alt="infoAlt" style=" border:none; float:left; width:8%; margin-top:5px;  ">
 <asp:Label ID="TxtCoupon" text="Apply Coupon"  type="text" class="form-control" CausesValidation="false" style=" border:none; float:left; width:80%;  font-size:16px;   font-weight: 600;    border-radius: 0px;"   runat="server"></asp:Label>
	<img src="img/coupongo2.png" alt="Coupons" style=" width:7%;  margin-top:8px; float:left;"  /></a>
  
   </div>
   
   <div style=" color:Red; float:none; width:100%; font-weight:600;"> <asp:Label ID="NotApplied" style=" text-align:left;"  runat="server" Visible="false"  Text="*This coupon either doesn't exists or expired."></asp:Label></div>
</div>
...
<center>
	<asp:LinkButton ID="LnkCouponApplied" runat="server" Text="Coupon Applied" OnClick="ChangeCoupon"  ClientIDMode="Static" style=" color:Maroon; font-weight:600; margin:0 auto "   ></asp:LinkButton> 
	</center>
</div>
 ...
 <div class="titleback" style=" background-image:url('strip/8.jpg'); color: #03A9F4; height:40px; font-size:15px; padding-top:11px; margin-top:4px; " >
  ...
  <div class="row" style=" float:none; width:100%; margin-top: 5px;"><span style="font-size:18px;">Qty - </span>
   ...
   <b style="font-size:14px">RS </b><span style="color:#1a1a1a; font-weight:700; font-size:14px;"><%# Eval("Price")%></span><br />
	  <div  runat="server" style="font-family: 'Roboto', sans-serif;
																						font-size: 14px; color: #84c225!important; line-height: 30.2px !important;
																						white-space: nowrap; text-overflow: ellipsis;" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" visible='<%# Eval("Cashback")%>' > Rs. <%# Eval("TotalCashback")%> </div>
  ...
  <div id="BntCheckOutLeft" class="actions row" runat="server"  style="  padding: 4px;  padding-top: 6px;  padding-left:10px;   background-color: white; text-align:left;  font-size: 15px; font-weight:500;     font-family: 'roboto';    box-shadow: 0 0 2px #888; ">
					 
					<div class="price">Total Price<asp:Label   ID="TxtSubtotal" style=" float:right; margin-right:10px;" runat="server" ></asp:Label></div>
					<div class="price">Discount<asp:Label   ID="TxtDiscount" style="  float:right; margin-right:10px;" runat="server" Text="0" ></asp:Label></div>
					<div class="price">Delivery<asp:Label   ID="DeliveryC" style=" float:right; margin-right:10px;" runat="server" ></asp:Label></div>
					<div class="price">Payable Amount<asp:Label   ID="TxtPayable" style=" float:right;margin-right:10px;" runat="server" ></asp:Label></div>
	  <div class="price">Total Cashback<asp:Label   ID="LblCashback" style=" float:right;margin-right:10px;" runat="server" ></asp:Label></div>
					<div class="price">Total MRP <asp:Label   ID="TxtTotalMrp" style=" float:right; margin-right:10px;" runat="server" ></asp:Label></div>
					<div class="price">Total Saved<asp:Label   ID="TSaved" style=" float:right;margin-right:10px;  " runat="server" ></asp:Label></div>
	  ...
	  <div runat="server" id="NoItemFound" style="width:98%;  margin:60px auto;  padding: 6px; padding-top:15px; padding-bottom:15px; background:white;box-shadow: 5px 8px 6px -6px rgba(0, 0, 0, 0.19);" visible="false">
		  ...
		  <h3>We are sorry, no product found.</h3>
				  Please add some product to checkout<br /><br />
 ...
 <asp:Button ID="Button1"  CssClass="MyfullBottomBtn" runat="server" Text="Proceed To Checkout" CausesValidation="false"  onclick="Button1_Click1"></asp:Button>
