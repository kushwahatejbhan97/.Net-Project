<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="KiranaWorldApp._default" %>
...
<title>KiranaWorld</title>
    ...
    <link href="css/AppStyle.css"  type="text/css"  rel="stylesheet" media="all" />
...
<div class="row"  style="background-color:#FFEB3B; height:70px;   " >
   ...
   <div class="col-xs-10 col-sm-10 col-md-10  col-lg-10" style="text-align:center;  color: #071463; font-size:20px; padding-top:20px; " > <a  runat="server" id="CustName" style=" text-transform:capitalize" href="Account.aspx">  Kirana World</a> </div>
   <div class="col-xs-2 col-sm-2 col-md-2  col-lg-2" style=" height:100%;   padding-top:16px; background-color: #0000006b; text-align:right; padding-right: 4px;"   ><a href="Account.aspx" ><i style="  font-size:30px; color:#ffffffc7;" class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
 ...
 <li><span class="home1"><img src="img/Menucategory.png" alt="Menucategory" class="MymenuImg" /> &nbsp;Categories</span>
    ...
    <ul style="">
                        ...
                        <a href="SubCatDetails.aspx?CatId=47"> &nbsp;Eggs , Meat &amp; Fish </a>
 ...
 <li><a href="Account.aspx" class="home1"><img src="img/MenuAddress.png" alt="MenuAddress" class="MymenuImg"  /> &nbsp; My Addresses</a></li>
 <li><a href="Account.aspx" class="home1"><img src="img/MenuCart.png" alt="orders"  class="MymenuImg" /> &nbsp; Orders</a></li>
 <li><a href="CartReview.aspx"  class="home1"><img src="img/MenuCart2.png" alt="My Cart"  class="MymenuImg" /> &nbsp; My Cart</a></li>
 <li><a href="ItemList.aspx?Type=3"  class="home1"><img src="img/MenuGift.png" alt="Offers"  class="MymenuImg" /> &nbsp; Offers</a></li>
 <li><a href="Account.aspx" class="home1"><img src="img/MenuWallet.png" alt="My Wallet"  class="MymenuImg" /> &nbsp; My Wallet</a></li>
<li><a href="whatsapp://send?text=Hello%2C%20I%20like%20to%20order%20with%20KiranaWorld.&phone=+918877778770"  class="home1"><i class="fa fa-whatsapp" aria-hidden="true"></i> &nbsp; Order From Whatsapp </a></li>
 ...
 <li><a href="Account.aspx" class="home1"><img src="img/MenuOut.png" alt="My Wallet"  class="MymenuImg" /> &nbsp; Sign In / Sign Up</a></li>
...
<div id="page" style="background:#d0d0d0c9!important"> 
  ...
  <div class="mm-toggle-wrap"  style="   position: fixed; z-index:40; width:33px !important; overflow:hidden;  " >
        ...
        <div style="   position: fixed; width:80%; left:13%; top:17px; z-index:40;  "  >
           <div style=" font-weight:600; line-height:20px; font-size:16px;">Welcome To Kirana World</div>
